...
router.delete('/categoryFixed/:id',ControllerFixed.deleteCategoryFixed)
...
router.delete('/categoryRent/:id',ControllerRent.deleteCategoryRent,)
router.get('/categoryRent',ControllerRent.getCategoryRent)
router.get('/subCategoryRent',ControllerRent.getSubCategory)
router.get('/subCategoryRent/:id',ControllerRent.getSubCategoryById)
...
// blogs
router.get('/blogs',ControllerBlogsTools.readBlogs)
